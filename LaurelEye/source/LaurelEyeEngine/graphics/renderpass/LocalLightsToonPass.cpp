...
namespace LaurelEye::Graphics {
    ...
    void LocalLightsToonPass::setup(RenderResources& rs) {
        shader = ShaderManager::getInstance().loadFile("LocalLightsToonPass", "../../../assets/shaders/LocalLights_Toon.frag\n../../../assets/shaders/LocalLights.vert");
    ...
    void LocalLightsToonPass::execute(const FrameContext& ctx) {
