...
//namespace LaurelEye::Audio {
//
//    class AudioAsset : public LaurelEye::IO::IAsset {
//    public:
...
//
//        const std::string& getPath() const { return path; }
//        AudioState getState() const { return state.load(); }
//        bool isReady() const { return state.load() == AudioState::Ready; }
//        LaurelEye::Audio::SoundHandle getHandle() const { return handle; }
//
//        // IAudioManager is the only FMOD-aware layer — AudioAsset just asks it
//        void load(LaurelEye::Audio::IAudioManager& manager, bool is3D, bool loop);
//        void loadAsync(LaurelEye::Audio::IAudioManager& manager, AudioLoader& loader, bool is3D, bool loop);
//        void waitForLoad();
//
//    private:
//        std::string path;
//        LaurelEye::Audio::SoundHandle handle = NULL_SOUND; // no FMOD types
//        std::atomic<AudioState> state;
